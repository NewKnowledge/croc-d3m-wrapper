...
class croc(PrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    metadata = metadata_base.PrimitiveMetadata({
        ...
        "installation": [
              ...
              {
                  "type": "PIP",
                  "package_uri": "git+https://github.com/NewKnowledge/nk_croc.git@ea2f35e0cc329b32c02dc52911a72a7b2531eee8#egg=nk_croc"
              },
              {
                  "type": "PIP",
                  "package_uri": "git+https://github.com/NewKnowledge/croc-d3m-wrapper.git@{git_commit}#egg=CROCd3mWrapper".format(
                    git_commit="1a75de2ef604f8824316a6390a546189bcd883e6")
              }
        ],
